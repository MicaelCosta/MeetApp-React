...
import { loadMeetupSuccess, createMeetupSuccess, updateMeetupSuccess } from './actions';

export function* createMeetup({ payload }){
    try{
        const { title, file_id, description, location, date_meetup } = payload.data;
...
export function* updateMeetup({ payload }){
    try{
        const { id, title, file_id, description, location, date_meetup } = payload.data;
